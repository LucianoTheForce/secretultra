...
const PRESETS = [
  { id: "pose-parado", prompt: "Ultrinho parado em pose neutra, corpo inteiro centralizado, studio branco puro" },
  { id: "pose-andando", prompt: "Ultrinho andando com passo curto, corpo inteiro centralizado, studio branco puro" },
  { id: "pose-correndo", prompt: "Ultrinho correndo com energia, corpo inteiro centralizado, studio branco puro" },
  { id: "pose-bracos-levantados", prompt: "Ultrinho com os bracos levantados, corpo inteiro centralizado, studio branco puro" },
  { id: "pose-bracos-cruzados", prompt: "Ultrinho parado com bracos cruzados, corpo inteiro centralizado, studio branco puro" },
  { id: "pose-sentado", prompt: "Ultrinho sentado com maos nos joelhos, corpo inteiro centralizado, studio branco puro" },
  { id: "pose-acenando", prompt: "Ultrinho acenando com a mao direita, corpo inteiro centralizado, studio branco puro" },
  { id: "pose-apontando", prompt: "Ultrinho apontando para frente com a mao direita, corpo inteiro centralizado, studio branco puro" },
  { id: "pose-lateral", prompt: "Ultrinho de lado em pose neutra, corpo inteiro centralizado, studio branco puro" },
  { id: "pose-ajoelhado", prompt: "Ultrinho ajoelhado com uma mao apoiada, corpo inteiro centralizado, studio branco puro" },
  { id: "pose-maos-na-cintura", prompt: "Ultrinho com maos na cintura, corpo inteiro centralizado, studio branco puro" },
  { id: "pose-segurando-botijao", prompt: "Ultrinho segurando um botijao pequeno, corpo inteiro centralizado, studio branco puro" },
]
...
async function main() {
  ...
  for (const preset of PRESETS) {
    ...
    const messages = [
      {
        role: "system",
        content: "Você gera imagens do mascote Ultrinho em estúdio branco.",
      },
      {
        role: "user",
        content: [
  ...
  console.log("Finished generating preset icons.")
}
